...
"""
    ...
    def test_empty_required_block_scalar_field_is_reported_missing(self) -> None:
        content = """---
...
"""
        ...
        self.assertTrue(any("missing required frontmatter field 'purpose'" in err for err in errors))
